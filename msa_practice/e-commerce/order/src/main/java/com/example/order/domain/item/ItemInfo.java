...
public class ItemInfo {
    ...
    public static class Main {
        ...
        private Main(Item item, List<ItemOptionGroupInfo> itemOptionGroupInfoList) {
        ...
        public static Main of(Item item, List<ItemOptionGroupInfo> itemOptionGroupInfoList) {
