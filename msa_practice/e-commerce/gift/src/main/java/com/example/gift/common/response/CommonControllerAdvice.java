...
import com.example.gift.common.exception.BaseException;
import com.example.gift.common.interceptor.CommonHttpRequestInterceptor;
...
public class CommonControllerAdvice {
    ...
    public CommonResponse<Void> skipException(Exception e) {
        String eventId = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY);
    ...
    public CommonResponse<Void> methodArgumentNotValidException(MethodArgumentNotValidException e) {
        String eventId = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY);
