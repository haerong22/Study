...
import com.example.inventoryapp.test.fixture.InventoryFixture;
...
public class InventoryControllerTest {
    ...
    class UpdateStock {
        ...
        void test1() throws Exception {
            ...
            final Map<String, Object> requestBody = Map.of("stock", stock);
        ...
        void test2() throws Exception {
            ...
            mockMvc.perform(
                    ...
                    .andExpect(status().isBadRequest())
                    .andExpectAll(
                            jsonPath("$.error.code").value(1003L),
                            jsonPath("$.error.local_message").value("재고가 유효하지 않습니다.")
                    );
        }
