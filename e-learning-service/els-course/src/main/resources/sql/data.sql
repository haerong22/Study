...
INSERT INTO COURSES (id, title, description, instructor_id, created_at)
...
INSERT INTO COURSE_SESSIONS (id, course_id, title)
...
INSERT INTO COURSE_RATINGS (id, course_id, user_id, rating, comment, created_at)
VALUES (100, 100, 100, 5, '훌륭한 강의입니다!', '2023-01-03 12:00:00'),
       (200, 100, 200, 4, '아주 좋았지만 조금 어려웠어요', '2023-01-04 12:00:00'),
       (300, 200, 300, 5, '초보자에게 최고의 강의', '2023-01-05 12:00:00'),
       (400, 200, 400, 3, '내용은 좋지만 구성이 조금 아쉽네요', '2023-01-06 12:00:00');